...
<!-- ============================================================= -->
<!--  NLM Citations                                                -->
<!--  Modified by: Joseph Liversedge <liversedgej@vtls.com> from   -->
<!--       original available at: http://dtd.nlm.nih.gov/tools/    -->
<!-- ============================================================= -->
...
<xsl:transform  version="1.0" 
                ...
                extension-element-prefixes="xlink m">
...
<!-- ============================================================= -->
<!--  1. GLOBAL DECLARATIONS: VARIABLES (NAMED CONSTANTS),         -->
...
<!--  Organization of output:
         make-html-head
         make-front-matter
         apply-templates /article/body
         apply-templates /article/back
...
<!-- ============================================================= -->
<!-- citation, for NLM Archiving DTD                               -->
<!-- ============================================================= -->
...
<xsl:template match="ref/citation">
    ...
    <xsl:choose>
      <!-- if have text content -->
      <xsl:when test="text()">
        <xsl:apply-templates mode="none"/>
      </xsl:when>
      
      <!-- if have only elements -->
      <xsl:otherwise>
...
<!-- ============================================================= -->
<!-- nlm-citation, for NLM Publishing DTD                          -->
<!-- ============================================================= -->
...
<xsl:template match="trans-title" mode="article-meta">
  <br/>
  <b><xsl:text>[Translated title: </xsl:text></b>
  <xsl:apply-templates/>
...
<xsl:template match="alt-title" mode="article-meta">
  <br/>
  <b><xsl:text>[Alternate title: </xsl:text></b>
  <xsl:apply-templates/>
  <b><xsl:text>]</xsl:text></b>
</xsl:template>
