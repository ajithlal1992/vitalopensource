...
/*
-bash-3.00$ ./j2kdriver -i sample-jpeg2000.jp2  --image-tiling-info --get-input-image-info --get-input-j2k-num-comments --image-progression-info --get-input-j2k-component-registration --get-input-j2k-selected-tile-geometryTiling information:
  tile offset: 0,0
  tile size: 1024,1024
  image offset: 0,0
Uncompressed image information:
   8752 columns by 6288 rows, 3 channels, 24 bpp = 165097728 bytes
Found 0 comments
Progression information:
  ...
  Color channels: 3
  Precincts: 1
  Progression level available: 1 (1 is max, 9 is min)
  */